...
/*********************************************************************
** Function: Bats()
** Description: Initializes the Bats object and overwrites the near 
** message. 
** Parameters: none
...
** Post-Conditions: 
*********************************************************************/
void Bats::set_location(int x, int y){
    this->location_x = x;
    this->location_y = y;
}
...
/*********************************************************************
** Function: ~Bats()
** Description: Deletes Bats event object
** Parameters: none
